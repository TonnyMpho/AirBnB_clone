#!/usr/bin/python3
"""Definition of unittests for models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    """This class defines unittests for testing instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """This class defines unittests for testing save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """This class defines unittests for testing to_dict method of the City class."""
